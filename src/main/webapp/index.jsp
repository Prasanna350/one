...
<head>
  ...
  <style>
    /* ===== NEW THEME — clean, modern, slightly techy ===== */
    :root {
      --bg: #f4f6fb;
      --surface: #ffffff;
      --surface-2: #f9fafc;
...
<script>
  // ============================================================
  //  PRODUCT DATA — Electronics, Clothing, Accessories
  // ============================================================
  const PRODUCTS = [
    // --- Electronics ---
    ...
    { id: 21, title: "Wireless Charging Pad", price: 39, old: 55, category: "Accessories", badge: "Sale", img: "https://images.unsplash.com/photo-1591290619762-49e2c3a5f5f2?w=600&q=80&auto=format&fit=crop", rating: 4, reviews
